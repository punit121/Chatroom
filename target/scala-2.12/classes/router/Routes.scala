...
class Routes(
  ...
  // @LINE:7
  private[this] lazy val controllers_HomeController_chat1_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("chat")))
  )
  private[this] lazy val controllers_HomeController_chat1_invoker = createInvoker(
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:7
    case controllers_HomeController_chat1_route(params@_) =>
      call { 
        controllers_HomeController_chat1_invoker.call(HomeController_0.chat)
      }
